...
<div x-data="surveyData()" x-init="init()">
    ...
    <!-- Feedbackfunktion -->
    <!-- Trigger/Open The Modal -->
    <div class="btn" onclick="#" id="feedbackButton"><img src="assets/questionTag.png" width="99" height="99" alt="?"></div>

    <!-- The Modal -->
    <div id="feedbackModal" class="modal">
        <!-- Modal content -->
        <div class="modal-content">
            <?php include("feedback_content.php"); ?>
        </div>
    </div>
    <script>
        // Get the modal
